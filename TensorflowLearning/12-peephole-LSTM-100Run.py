...
from Models import peephole_LSTM_2Layers
...
for R in range(nRandom_start):
    ...
    optimizer, output, sharpe_plus_l2_loss = peephole_LSTM_2Layers(x, y, weights, biases, keep_prob, curr_optimizer,
