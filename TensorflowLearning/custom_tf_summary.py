...
class Logger(object):
    ...
    def __init__(self, writer):
        ...
        :param writer: summary_file_writer instance 
        """
        self.writer = writer
    ...
    def log_images(self, tag, images, step):
        ...
        :param tag: Name of the image summary
        :param images
        :param step: training iteration
        """
    ...
    def log_histogram(self, tag, values, step, bins=50):
        ...
        :param tag: Name of the histogram summary
        :param values the numpy array of values
        :param step: training iteration
        """
