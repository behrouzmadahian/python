...
from Models import bidirectional_attention_LSTM
...
exponential_decay_rate = 0.99999
batch_size = 100
display_steps = 1
...
for R in range(nRandom_start):
    ...
    weights = {
        ...
        'out': initializers.xavier_from_tf_initializer([2 * hidden2_size , 1], name='W_out')
    }
    ...
    optimizer, output, sharpe_plus_l2_loss = bidirectional_attention_LSTM(x, y, weights, biases, keep_prob, curr_optimizer,
