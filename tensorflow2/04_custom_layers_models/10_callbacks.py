...
# "no longer improving" being defined as min delta "no better than 1e-2 less"
# patience: "no longer improving" being further defined as "for at least 2 epochs"
...
model.fit(data_dict_x, data_dict_y, epochs=500, batch_size=64, validation_data=(data_dict_x_v, data_dict_y_v),
          callbacks=callbacks)
