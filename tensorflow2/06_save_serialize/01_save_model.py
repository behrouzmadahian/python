...
- you can later recreate the samne model from this file, even if you no longer have access to the
code that created the model. This file includes:

- The Model's architecutre
