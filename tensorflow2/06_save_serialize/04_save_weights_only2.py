"""
Sometime you are interested in Model weights and not in architecutre.
...
You cna combine get_config();  from_config() and get_weights, set_weights() to re-create your model in the same state
