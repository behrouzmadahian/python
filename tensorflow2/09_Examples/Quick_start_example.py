...
# These metrics accumulate the values over epochs and then pront the overall results
...
def train_step(images, labels):
  with tf.GradientTape() as tape:
    ...
    print('Shape of loss coming out of loss object: {}'.format(loss))
...
def test_step(images, labels):
  ...
  print('Shape of test loss coming out of loss object: {}'.format(loss))
  test_loss(t_loss)
