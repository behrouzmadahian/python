    ...
    def __init__(self, s_size, a_size, scope, optimizer):
        ...
        with tf.variable_scope(scope):
            ...
            if scope != 'global':
                ...
                # helps avoiding convergence to premature deterministic policies!
...
class Worker(object):
    ...
    def train(self, rollout, sess, gamma, lmbda, bootstrap_value, gae=True):
        ...
        if gae:
            ...
            advantages = discount(advantages, adv_dicount)
        ...
        feed_dict = {self.local_agent.target_v: discounted_rewards,  # used to update value function
                     ...
                     self.local_agent.advantages: advantages,  # used to update policy
