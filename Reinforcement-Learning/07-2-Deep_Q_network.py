...
class DQN(object):
    ...
    def __init__(self, n_actions, hidden=1024, learning_rate=0.00001,
        ...
        # Action that was performed- needed since we do exploration time to time:
...
# e greedy exploration exploitation strategy
class ActionGetter(object):
    ...
    def __init__(self, n_actions, eps_initial=1, eps_final=0.1, eps_final_frame=0.01, eps_evaluation=0.0,
        ...
        # Sploes and intercepts for exploration decrease:
...
"""
We want to store last 10^6 transions in the form of [st, at, rt, terminal, s_t+1]
...
class ReplayMemory(object):
    """
    Replay memory that stores the last 1 million transitions
    """
    def __init__(self, size=1000000, frame_height=84, frame_width=84, agent_history_length=4, batch_size=32):
        """
        :param size: int, size of the stored transitions
        ...
        for i in range(self.batch_size):
            while True:
                ...
                if index < self.agent_history_length:
                    continue
                # current holds location of most recent frame added! any frame after it is not
...
def learn(session, replay_memory, main_dqn, target_dqn, batch_size, gamma):
    ...
    # Multiplication with (1- terminal_flags) makes sure that id the game is over, targetQ = reward
...
class TargetNetworkUpdater(object):
    ...
    def _update_target_vars(self):
        update_ops = []
        for i, var in enumerate(self.target_dqn_vars):
...
def generate_gif(frame_number, frames_for_gif, reward, path):
    ...
    :param reward: int, total reward of the episode that ouputed as a gif
...
"""
If agent loses a life, at there's no penalty at the current environment.
...
between 1 and 10. this ensures that the agent starts in a different situation everytime  and thus 
...
PATH = "/Users/behrouzmadahian/Desktop/python/Reinforcement-Learning/dqn_atari/output/"                 # Gifs and checkpoints will be saved here
SUMMARIES = "/Users/behrouzmadahian/Desktop/python/Reinforcement-Learning/dqn_atari/summaries"          # logdir for tensorboard
RUNID = 'run_1'
...
# Setting up tensorboard summaries for the loss, the average reward, the evaluation
# score and the network parameters to observe the learning process:
        ...
        while frame_number < MAX_FRAMES:
            ...
            while epoch_frame < EVAL_FREQUENCY:
                ...
                if len(rewards) % 10 == 0:
                    ...
                    print('reward_seq_len', 'frame_number', 'mean_last_100_rewards')
...
if TEST:
    ...
    if ENV_NAME == 'BreakoutDeterministic-v4':
        ...
        save_file = "my_model-15845555.meta" # Get this from check point file!
