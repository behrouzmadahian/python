...
the Huber_loss only exists for 1500 batches!!!
...
# results save folder
# results save folder
root = 'C:/behrouz/Research_and_Development/GANS/codes/SSGAN/results_ver3/'
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epoch):
        ...
        print('Epoch= ', epoch, 'Train Accuracy-all labeled=', train_acc,'Accuracy partial label=', train_acc_masked,
              'Train d loss= ', train_d_l, 'Train g loss= ', train_g_l)
        print('Epoch= ', epoch, 'Test Accuracy=', test_acc, 'Accuracy partial label=', test_acc_masked,
