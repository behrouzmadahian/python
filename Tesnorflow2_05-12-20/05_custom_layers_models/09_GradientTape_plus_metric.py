"""
You can write your own training and evaluation loops: Using GradientTape
...
You can readily reuse the builtin metrics(or custom ones you wrote) in such training loops written from scratch:
    ...
    for step, (x_batch_train, y_batch_train) in enumerate(train_dataset):
        ...
        with tf.GradientTape() as tape:
          ...
          if step % 200 == 0:
              ...
              print('Total samples seen so far {} . Samples'.format((step + 1) * 64))
